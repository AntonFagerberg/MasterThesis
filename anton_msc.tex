...
The Streamflow API also doesn't compress the responses. By adding a gzip compression in the API-gateway before responding to the client, the data could be reduced even more, from 1,100 KB to 9.9 KB - a 99\% decrease of transmitted data!
