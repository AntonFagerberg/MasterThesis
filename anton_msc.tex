...
It is hard to argue for the inclusion of an API-gateway in the current state of this project because of the facts that the Bank App did already have a cross-platform shared code base and well suited end-points. In this case, the API-gateway would most likely serve as an unnecessary layer of complexity where the benefits wouldn't outweigh the drawbacks.
