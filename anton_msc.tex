...
\theabstract{
This thesis investigates the benefits and complications around working with API gateways in order to optimise the communication and interaction between clients and servers. We do this by examining the underlying protocol HTTP and the general theory regarding API gateways.

An API gateway framework was developed to help further understanding some of the common problems and provide a way to rapidly develop prototype solutions to them. This framework was then applied in three case studies in order to find problematic areas and solve them in real world production systems used in the industry.
}
