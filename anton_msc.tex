...
Lastly, there is also an error field which the user can utilise to handle all kinds of errors such as DNS lookup failures, non-responding back-ends but also thrown exceptions. A full description of the error handling mechanism is however outside the scope of this brief introduction.
